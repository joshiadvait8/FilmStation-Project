...
.input_qty_sm label output {
  ...
  font-weight: 600;
     ...
     <div><input id="high-low" class="btn btn-default" type="button" value="high-low" onclick="desc();" /> </div>
     <div><input id="low-high" class="btn btn-default" type="button" value="low-high" onclick="asc();" /> </div>
    <div class="container">
      <div class="row">
              ...
              <ItemTemplate>
                  <div class="col-sm-6 col-md-4">
                      <div class="shop__thumb">
                          <a href="Default2.aspx?id=<%# Eval("p_id") %>">
                              <div class="shop-thumb__img">
                                  <img src="imagess/<%# Eval("p_image") %>" class="img-responsive my " alt="<%# Eval("p_name") %>">
                              </div>
                              <h5 class="shop-thumb__title"><%# Eval("p_name") %>
                                  <span class="badge pull-right"><%#Eval("p_brand") %> </span>
                              </h5>
                              
                              <div class="shop-thumb__price">
                               
                                 <i class="fa fa-rupee"> </i> <span class="shop-thumb-price_new"><%# Eval("p_price") %></span>
        ...
        <!--  <asp:SqlDataSource runat="server" ID="SqlDataSource1" ConnectionString='<%$ ConnectionStrings:FilmStationConnectionString %>' SelectCommand="SELECT * FROM [product]"></asp:SqlDataSource>-->
        ...
        <script type="text/javascript">
            function desc() {
                window.location = "Product.aspx?sort=" + document.getElementById("high-low").value;
            }
            function asc() {
                window.location = "Product.aspx?sort=" + document.getElementById("low-high").value;
            }
    </script>
     <script type="text/javascript">
