  ...
  font-weight: 600;
    ...
    <div class="container">
      <div class="row">
          ...
          <asp:SqlDataSource runat="server" ID="CatSortSqlDataSource" ConnectionString='<%$ ConnectionStrings:FilmStationConnectionString %>' SelectCommand="SELECT * FROM [product] WHERE ([cat_id] = @cat_id)">
              <SelectParameters>
